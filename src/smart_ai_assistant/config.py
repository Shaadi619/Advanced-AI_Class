...
class AppConfig:
    text_model_id: str = os.getenv("TEXT_MODEL_ID", "google/flan-t5-base")
    ...
    text_max_new_tokens: int = int(os.getenv("TEXT_MAX_NEW_TOKENS", "60"))
    text_candidate_pool_size: int = int(os.getenv("TEXT_CANDIDATE_POOL_SIZE", "9"))
    text_min_words: int = int(os.getenv("TEXT_MIN_WORDS", "12"))
